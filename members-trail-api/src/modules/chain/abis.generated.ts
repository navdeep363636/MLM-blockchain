...
export const mttTokenAbi = [
  ...
  {
    "inputs": [],
    "name": "ALLOC_TREASURY_RESERVE_BPS",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "",
...
/** Every function on MTTToken. A typo is a compile error, not a revert. */
export type TokenFunction =
  | "ALLOC_ADVISORS_BPS"
  | "ALLOC_LIQUIDITY_BPS"
  | "ALLOC_MARKETING_BPS"
  | "ALLOC_REWARDS_POOL_BPS"
  | "ALLOC_TEAM_BPS"
  | "ALLOC_TREASURY_RESERVE_BPS"
  | "BURNER_ROLE"
  | "DEFAULT_ADMIN_ROLE"
  | "PAUSER_ROLE"
  | "TOTAL_SUPPLY"
...
/** Every event MTTStaking can emit. */
...
/** Every function on MTTReferralDistributor. A typo is a compile error, not a revert. */
export type ReferralDistributorFunction =
  | "COMPLIANCE_ROLE"
  | "DEFAULT_ADMIN_ROLE"
  | "ORACLE_ROLE"
  | "TREASURY_ROLE"
...
/** Every event MTTReferralDistributor can emit. */
export type ReferralDistributorEvent =
  | "CommissionClaimed"
...
/** Every function on MTTVesting. A typo is a compile error, not a revert. */
export type VestingFunction =
  | "beneficiary"
  | "cliffDuration"
  | "releasable"
  | "release"
...
/** Every event MTTPayout can emit. */
